...
class CacheConfiguration(
    ...
    fun hazelcastInstance(jHipsterProperties: JHipsterProperties): HazelcastInstance {
        ...
        val hazelCastInstance = Hazelcast.getHazelcastInstanceByName("alert")
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized")
            return hazelCastInstance
        }
        val config = Config()
        config.instanceName = "alert"
        ...
        config.mapConfigs["com.okta.developer.alert.domain.*"] = initializeDomainMapConfig(jHipsterProperties)
